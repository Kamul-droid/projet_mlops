...
def train_and_log_model():
    """Entraîne le modèle de régression logistique, enregistre les métriques et les artefacts dans MLflow."""
    ...
    logger.info(f"Modèle de régression logistique entraîné avec succès : Accuracy={accuracy}, F1 Score={f1}")
